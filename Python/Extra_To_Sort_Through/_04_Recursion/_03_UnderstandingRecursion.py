...
similar to how a recursive function call works:
    ...
    E.G. Sum List Recursively f([1,2,3,4])              see _01_Basics.py
        ...
        We see out the stack frame is built up with the function call and the
        return result, if we have a recursive call then it is add on top of the stack
        as it's own function call and so on until we get the base case, then the stack
