"""
We will look again at the case of converting an integer into a string with different base.

The key to this was the "Divide by x" method,
...
# Function that calls out recursion function and allows us to distinguish +ve and -ve
