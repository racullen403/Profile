...
We use Mapping for O(_01_BasicPython) look up times, instead of searching a full array which is O(n):
...
# Currently you must create the Queue from the ground up, I will implement a heapify method for an array maybe
...
print("\nTesting Indexed Priority Q\n")

q = IndexPriorityQueue()

print("Insert 'Ryan', priority 3")
q.q_insert("Ryan", 3)
print("MinHeap: " + str(q.is_min_heap()))
print(q.pm)
print(q.im)

print("\nInsert 'Shane', priority 2")
q.q_insert("Shane", 2)
print("MinHeap: " + str(q.is_min_heap()))
print(q.pm)
print(q.im)

print("\nInsert 'Cam', priority 0")
q.q_insert("Cam", 0)
print(q.pm)
print(q.im)

print("\nInsert 'Erin', priority 0")
q.q_insert("Erin", 0)
print(q.pm)
print(q.im)

print("\nInsert 'Dad', priority 5")
q.q_insert("Dad", 5)
print(q.pm)
print(q.im)

print("\nInsert 'Mum', priority 2")
q.q_insert("Mum", 2)
print(q.pm)
print(q.im)

print("\nInsert 'Dog', priority _01_BasicPython")
q.q_insert("Dog", 1)
print("MinHeap: " + str(q.is_min_heap()))
print(q.pm)
print(q.im)
...
print("\nChange Priority of Dog to 7")
q.change_priority("Dog", 7)
q.q_show()

print("\nChange Priority of Erin to 7")
q.change_priority("Erin", 7)
q.q_show()
print("MinHeap: " + str(q.is_min_heap()))

# print("\nDelete 'Dog'")
# q.q_delete("Dog", "Testing")
# print(q.pm)
# print(q.im)
#
# print("\nDelete 'Mum'")
# q.q_delete("Mum", "Testing")
# print(q.pm)
# print(q.im)
#
# print("\nDelete 'Cam'")
# q.q_delete("Cam", "Testing")
# print(q.pm)
# print(q.im)
#
#
...
# print("\nExtract Min")
# print(q.q_extract_min())
# q.q_show()
#
# print("\nChange Ryan Priority to 0")
# q.change_priority("Ryan", 0)
# q.q_show()
#
# print("\nChange Ryan Priority to 6")
# q.change_priority("Ryan", 6)
# q.q_show()
...
print("\nChecking logging is working")
for item in q.log:
    print(item)


print("\nContains Ryan")
print(q.q_contains("Ryan"))
print("\nDelete Ryan")
q.q_delete("Ryan")
print("\nContains Ryan")
print(q.q_contains("Ryan"))
