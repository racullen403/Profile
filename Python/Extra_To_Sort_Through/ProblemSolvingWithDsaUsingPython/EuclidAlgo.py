...
We use a series of steps such that the output of one is used as the input of the next.py
...
Procedure:
    ...
    - For k=0, r_(k-1) and r_(k-2) will be out 2 integers, r_(k-2) being the larger.
...
Example:
    ...
    GCD of a=36 and b=14, we know this should be 2.
        ...
        r_0 = 36 - 14*q_0
            ...
            q_0 = 1 -> r_0 = 22 > r_-1 = 14
            q_0 = 2 -> r_0 = 8 < r_-1 = 14   -> so q_0 = 2 and we move to k=1


        k=1
        r_1 = 14 - 8*q_1

            q_1 = 1  ->  r_1 = 6  <  r_0 = 8  -> so q_1 = 1 and we move to k=2


        k=2
        r_2 = 8 - 6*q_2

            q_2 = 1  ->  r_2 = 2  < r_1 = 6  ->  so q_2 = 1 and we move to k=3
