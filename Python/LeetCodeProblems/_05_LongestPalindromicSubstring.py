...
Solution 2:
    ...
    of palindromes that occur inside palindromes.
    ...
    - We will create a LPS (longest possible length) array with len(s)*2 + 1 spaces
    ...
    - If change c -> r if the palindrome centred at r expands beyond cr.
"""
